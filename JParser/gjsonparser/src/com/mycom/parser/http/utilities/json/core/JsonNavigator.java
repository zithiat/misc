...
/**
 * This class is for navigation the parsed output from Json parser
 */
public class JsonNavigator
{
  ...
  public JsonNavigator (CharBuffer buffer, IndexBuffer elementBuffer)
  {
    this.buffer = buffer;
  ...
  /**
   * Counts the number of elements in an array. Only works for arrays of
   * primitive elements, like strings, numbers, booleans, null etc. Arrays
   * containing objects or nested arrays will not be properly counted using this
   * method.
   */
  ...
  /**
   * Compares an un-encoded string to the current token value. The two strings
  ...
  public String asString ()
  {
    ...
    {
      return new String (this.buffer.data, this.elementBuffer.position[this.elementIndex], this.elementBuffer.length[this.elementIndex]);
    }
    ...
    case ElementTypes.JSON_PROPERTY_VALUE_STRING_ENC:
    {
      return asStringDecoded ();
    }
    case ElementTypes.JSON_ARRAY_VALUE_STRING_ENC:
    {
      return asStringDecoded ();
    }
    }

    return null; // or throw exception - element is not a string.
  }
  ...
  private String asStringDecoded ()
  {
    ...
    StringBuilder builder = new StringBuilder (length); // reserve enough space
