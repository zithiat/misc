...
public class JsonTokenizer
{
  ...
  private CharBuffer dataBuffer = null;
  ...
  public JsonTokenizer (CharBuffer dataBuffer, IndexBuffer tokenBuffer)
  {
  ...
  public void reinit (CharBuffer dataBuffer, IndexBuffer tokenBuffer)
  {
    this.dataBuffer = dataBuffer;
    this.tokenBuffer = tokenBuffer;
    this.tokenIndex = 0;
  ...
  public void parseToken ()
  {
    ...
    case '{':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_CURLY_BRACKET_LEFT;
    }
      break;
    case '}':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_CURLY_BRACKET_RIGHT;
    }
      break;
    case '[':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_SQUARE_BRACKET_LEFT;
    }
      break;
    case ']':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_SQUARE_BRACKET_RIGHT;
    }
      break;
    case ',':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_COMMA;
    }
      break;
    case ':':
    {
      /* this.tokenLength = 1; */ this.tokenBuffer.type[this.tokenIndex] = TokenTypes.JSON_COLON;
    }
      break;
  ...
  {
    if (this.dataBuffer.data[this.dataPosition + 1] == 'u' && this.dataBuffer.data[this.dataPosition + 2] == 'l' && this.dataBuffer.data[this.dataPosition + 3] == 'l')
    {
      // this.tokenLength = 4;
      return true;
    }
  ...
  {
    if (this.dataBuffer.data[this.dataPosition + 1] == 'r' && this.dataBuffer.data[this.dataPosition + 2] == 'u' && this.dataBuffer.data[this.dataPosition + 3] == 'e')
    {
      this.tokenLength = 4;
      return true;
    }
  ...
  {
    if (this.dataBuffer.data[this.dataPosition + 1] == 'a' && this.dataBuffer.data[this.dataPosition + 2] == 'l' && this.dataBuffer.data[this.dataPosition + 3] == 's' && this.dataBuffer.data[this.dataPosition + 4] == 'e')
    {
      this.tokenLength = 5;
      return true;
    }
  ...
  private void parseStringToken ()
  {
    ...
    this.tokenBuffer.position[this.tokenIndex] = this.dataPosition + 1; // +1 to
                                                                        // skip
                                                                        // over
                                                                        // the
                                                                        // beginning
                                                                        ...
                                                                        // char
                                                                        // (")
    this.tokenLength = (tempPos - this.dataPosition - 1); // +2 to include the
                                                          // enclosing quote
                                                          // chars ("").
